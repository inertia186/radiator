...
module Radiator
  class MarketHistoryApiTest < Radiator::Test
    ...
    def test_get_market_history
      VCR.use_cassette('get_market_history', record: VCR_RECORD_MODE, match_requests_on: [:method, :uri, :body]) do
    ...
    def test_get_market_history_buckets
      VCR.use_cassette('get_market_history_buckets', record: VCR_RECORD_MODE, match_requests_on: [:method, :uri, :body]) do
    ...
    def test_get_order_book
      VCR.use_cassette('get_order_book', record: VCR_RECORD_MODE, match_requests_on: [:method, :uri, :body]) do
    ...
    def test_get_recent_trades
      VCR.use_cassette('get_recent_trades', record: VCR_RECORD_MODE, match_requests_on: [:method, :uri, :body]) do
    ...
    def test_get_ticker
      VCR.use_cassette('get_ticker', record: VCR_RECORD_MODE, match_requests_on: [:method, :uri, :body]) do
    ...
    def test_get_trade_history
      VCR.use_cassette('get_trade_history', record: VCR_RECORD_MODE, match_requests_on: [:method, :uri, :body]) do
    ...
    def test_get_volume
      VCR.use_cassette('get_volume', record: VCR_RECORD_MODE, match_requests_on: [:method, :uri, :body]) do
